 ...
 */
export function createDefaultBoard(name: string = 'Untitled Board'): Omit<Board, 'id' | 'createdAt' | 'updatedAt'> {
  return {
    name,
    elements: [],
    preferences: {
 ...
 */
export function getSchemaByCollection(collectionName: keyof typeof databaseSchemas): RxJsonSchema<any> {
