...
export const CANVAS_COLOR_PRESETS = {
	basic: [
		...
		{
			name: "Red",
			value: "var(--stroke-secondary)",
			element: "stroke-secondary",
		},
		{ name: "Blue", value: "var(--stroke-accent)", element: "stroke-accent" },
		{
			name: "Green",
			value: "var(--stroke-success)",
			element: "stroke-success",
		},
		{
			name: "Yellow",
			value: "var(--stroke-warning)",
			element: "stroke-warning",
		},
	],
	extended: [
		{
	...
	fill: [
		...
		{
			name: "Highlight",
			value: "var(--fill-highlight)",
			element: "fill-highlight",
		},
	],
} as const;
